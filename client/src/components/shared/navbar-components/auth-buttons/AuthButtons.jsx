      ...
      {user ? (
        <div className="dropdown dropdown-end">
          ...
          >
            ...
            <li className="px-4"><div className="divider my-0"></div></li>
        ...
        <div className="hidden lg:flex gap-3">
          <Link to="/auth/signin">
            <button className="btn btn-primary normal-case px-4">Sign In</button>
          </Link>
          <Link to="/auth/register">
            <button className="btn btn-outline normal-case px-4">Sign Up</button>
          </Link>
        </div>
      )}
    </div>
