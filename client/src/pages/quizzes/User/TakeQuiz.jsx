  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {submitted && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            transition={{ duration: 0.6 }}
            className="fixed top-6 right-6 bg-white/60 dark:bg-gray-800/80 backdrop-blur-xl border border-white/20 shadow-2xl rounded-2xl p-5 w-72 z-50"
          >
            ...
            <div className="mt-3 text-sm text-gray-700 dark:text-gray-300 text-center">
              ✅ Correct: <span className="text-green-500">{score}</span> | ❌ Wrong:{" "}
      ...
      <div className="w-full max-w-3xl mb-6 mt-6">
        <div className="flex justify-between text-sm mb-1 font-semibold text-gray-700 dark:text-gray-200">
          <span>Progress</span>
                ...
                {[q.option1, q.option2, q.option3, q.option4].map((opt, idx) => {
                  ...
                  if (submitted) {
                    if (isCorrect)
                      ...
                      buttonStyle =
                        "bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-500 opacity-70";
                  } else {
                    buttonStyle = selected
                      ? "bg-gradient-to-r from-green-400 to-green-600 text-white border-transparent shadow-lg"
                      : "bg-white dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 border-gray-300 dark:border-gray-500";
                  }
