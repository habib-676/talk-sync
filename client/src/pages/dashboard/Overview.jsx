          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 shadow">
                <h3 className="text-lg font-semibold text-indigo-600 mb-3">Recent stats</h3>
                <div className="flex gap-4">
                  <div className="p-3 bg-gray-50 rounded-md">
                    <div className="text-sm text-gray-500">Sessions this week</div>
                    <div className="text-xl font-bold">{summary.sessionsThisWeek}</div>
                  </div>
                  <div className="p-3 bg-gray-50 rounded-md">
                    <div className="text-sm text-gray-500">Badges</div>
                    <div className="text-xl font-bold">{(summary.badges || []).length}</div>
                  </div>
                  <div className="p-3 bg-gray-50 rounded-md">
                    <div className="text-sm text-gray-500">Learners</div>
                    <div className="text-xl font-bold">{summary.learners.toLocaleString()}</div>
                  </div>
                </div>
              </div>

              <div className="bg-white rounded-2xl p-6 shadow">
                <h3 className="text-lg font-semibold text-indigo-600 mb-3">Community</h3>
                <div className="grid grid-cols-3 gap-3">
                  <div className="text-center">
                    <div className="text-2xl font-bold">{summary.learners.toLocaleString()}</div>
            ...
            <aside className="space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 shadow">
                <h3 className="text-lg font-semibold text-indigo-600">Suggested partners</h3>
